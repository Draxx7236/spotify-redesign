        ...
        <div className="flex items-center rounded-full border-2 border-[#262626] w-[85px] h-10 relative cursor-pointer group-hover:border-white/40">
          <AiFillHeart
            className={`text-xl ml-3 icon ${
              hasLiked ? "text-[#591db9]" : "text-[#868686]"
            }`}
          ...
          {track.uri === playingTrack.uri && play ? (
            <>
              <div
                className="h-10 w-10 rounded-full border border-[#341588] flex items-center justify-center absolute -right-0.5 bg-[#341588] icon hover:scale-110"
                onClick={handlePlay}
              >
            ...
            <>
              <div
                className="h-10 w-10 rounded-full border border-white/60 flex items-center justify-center absolute -right-0.5 hover:bg-[#341588] hover:border-[#341588] icon hover:scale-110"
                onClick={handlePlay}
              >
